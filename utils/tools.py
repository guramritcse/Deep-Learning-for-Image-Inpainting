...
def same_padding(imgs, ksizes, strides, rates):
    ...
    imgs = torch.nn.ZeroPad2d(paddings)(imgs)
    return imgs


def extract_image_patches(imgs, ksizes, strides, rates, padding='same'):
    if padding == 'same':
        imgs = same_padding(imgs, ksizes, strides, rates)
