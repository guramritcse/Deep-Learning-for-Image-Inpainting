...
parser.add_argument('--CA_map', type=str, default='')
...
with torch.no_grad():
    ...
    _, patch_recon, offset_flow = netG(data, mask)
    ...
    # Save the Contextual Attention map
    if args.CA_map:
        vutils.save_image(offset_flow, args.CA_map, padding=0, normalize=True)
        print("Saved offset flow to {}".format(args.CA_map))
